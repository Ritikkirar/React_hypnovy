...
import { changeMerchantPassword } from '../../../redux/actions/merchantAction'
...
const ChangePassword = ({ token }) => {
    ...
    const submitHandler = (e) => {
        ...
        if (oldPassword === newPassword) {
            ...
            dispatch(changeMerchantPassword(newPassword, token, navigate))
            setOldPassword('')
            setNewPassword('')
            setConfirmPassword('')
            setError('')
                                        ...
                                        <div className="mt-3" id="change_pwd">
                                            <form onSubmit={submitHandler}>
                                                <h5 className="mb-4 text-uppercase" style={{ fontSize: '0.9375rem', fontWeight: '700' }}>
                                                    <MdAccountCircle style={{ marginTop: '-3px' }} className='me-1' />
                                                    Change Password
                                                </h5>
